...
class LLMDecisionConfig:
    ...
    decision_low_score_min: float = field(default_factory=lambda: _env_float("LLM_DECISION_LOW_SCORE_MIN", 0.40))
    decision_low_score_max: float = field(default_factory=lambda: _env_float("LLM_DECISION_LOW_SCORE_MAX", 0.55))
    decision_low_score_second_min: float = field(default_factory=lambda: _env_float("LLM_DECISION_LOW_SCORE_SECOND_MIN", 0.20))
    decision_low_score_min_base: float = field(default_factory=lambda: _env_float("LLM_DECISION_LOW_SCORE_MIN_BASE", 0.18))
